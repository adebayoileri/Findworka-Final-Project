@extends("layouts.app")
@section('title')
    Findworka | Privacy Policy
@endsection
@section('content')
<h1> Welcome to our policy page </h1> 
    
This Privacy Policy governs the manner in which CoToNet Unip. Lda collects, uses, maintains and discloses information collected from users (each, a "User") of the https://www.mooc-list.com website ("Site").
...
CoToNet Unip. Lda may collect and use Users personal information for the following purposes:
...
CoToNet Unip. Lda has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.
