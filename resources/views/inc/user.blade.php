...
<head>
  ...
  <!-- End layout styles -->
  <link rel="shortcut icon" href="https://az742041.vo.msecnd.net/vcsites/vcimages/resource/uploads/CompanyLogo/icon_636208655838400948_1.png" />
</head>
<body>
<script src="../assets2/js/preloader.js"></script>
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      ...
      <div class="mdc-drawer__content">
        <div class="user-info">
          ...
          <p class="email">Logged In as {{Auth::user()->email}}</p>
        </div>
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-expansion-panel-link" href="/purchase/history" data-toggle="expansionPanel" data-target="sample-page-submenu">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">pages</i>
               Purchase History
              </a>
            </div>
            ...
            <div class="menu-button-container menu-profile d-none d-md-block">
              <button class="mdc-button mdc-menu-button">
                <span class="d-flex align-items-center">
                  <span class="figure">
                  <img src="/storage/photos/{{Auth::user()->photo}}" alt="user" class="user">
                  </span>
          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                <span class="tx-14">Copyright © 2020 <a href="/" target="_blank">Findworka Academy</a>. All rights reserved.</span>
              </div>
  ...
  <script src="../assets2/vendors/chartjs/Chart.min.js"></script>
  ...
  <!-- inject:js -->
  <script src="../assets2/js/material.js"></script>
